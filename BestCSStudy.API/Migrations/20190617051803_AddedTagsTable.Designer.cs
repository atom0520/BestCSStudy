...
namespace BestCSStudy.API.Migrations
{
    ...
    [Migration("20190617051803_AddedTagsTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BestCSStudy.API.Models.PostTag", b =>
                {
                    b.Property<int>("PostId");
            ...
            modelBuilder.Entity("BestCSStudy.API.Models.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("BestCSStudy.API.Models.PostTag", b =>
                {
                    ...
                    b.HasOne("BestCSStudy.API.Models.Tag", "Tag")
                        .WithMany("Posts")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
